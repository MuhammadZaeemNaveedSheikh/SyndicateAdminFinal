      ...
      >
        ...
        >
          ...
          <FormControl fullWidth>
            ...
            <Select
              IconComponent={() => (
                <ExpandMoreIcon fontSize="small" sx={{ color: "#D0D0D0" }} />
              )}
              // name={name}
              // value={value}
              // onChange={onChange}
          ...
          <div className="flex flex-row items-center justify-end gap-3 mt-6">
            <button className="font-normal text-sm font-[Montserrat] bg-[#5B1CD4] text-white cursor-pointer  p-[0.5rem] rounded-[4px]">
              Submit
            </button>
            <button
              className="font-normal text-sm font-[Montserrat] bg-white text-[#646464] cursor-pointer  p-[0.5rem] rounded-[4px]"
