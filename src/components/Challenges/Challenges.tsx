  ...
  return (
    <>
      <div className="mt-4 md:mt-11 mx-4 lg:mx-9">
        <div className="font-semibold text-[#221835] font-[Montserrat] text-[24px] lg:text-[38px] mt-4">
          Challenges
        </div>
        ...
        <div className="flex flex-col md:flex-row justify-between mt-6 items-start gap-y-3 md:items-center">
          <div className="font-semibold text-[#221835] font-[Montserrat] text-[20px] lg:text-[24px] line-[29.3px]">
            Your Activity
          </div>
          ...
          <div className="flex flex-row items-center gap-x-6 md:gap-x-2">
            ...
            <button
              ...
              className="bg-[#5B1CD4] text-white cursor-pointer  p-[0.99rem] rounded-lg"
            >
        ...
        <div className="bg-white mt-4 flex flex-col gap-y-9 padding-[1.5rem] w-full overflow-x-auto p-6 mb-3 rounded-lg">
          <div className="flex flex-row items-center gap-28">
            <div className="font-[Montserrat] font-semibold text-[16px] text-[#646464]">
              Balance
            </div>
            <div className="flex flex-row items-center gap-x-12 ">
              <div className="font-[Montserrat] font-semibold text-[16px] text-[#0F0B19]">
                $10,000
              </div>
              <div className="font-[Montserrat] font-semibold text-[16px] text-[#646464]">
                |
