...
import Logo from "../../assets/images/auth/authLogo.svg";
import forgotImage from "../../assets/images/auth/forgotPwdImage.png";
    ...
    <>
      <div className="w-full">
        <div className="w-full mt-10 mb-[1rem] ml-8 lg:ml-14">
          <img
            className="md:mb-8 lg:mb-10 xl:mb-12 2xl:mb-16 w-[229px] h-[34px]"
            src={Logo}
