    ...
    <div className="my-16 sm:my-[0px] sm:m-8 p-4 md:p-0">
      <div className="mt-4 md:mt-11 flex flex-col md:flex-row items-start md:items-center justify-start md:justify-between">
        ...
        <div className="flex flex-row items-center gap-2">
          <div className="font-[Montserrat] font-normal text-base text-[#646464]">
            Need Help
          </div>
          <img
            src="../Icons/needHelpIcon.svg"
            alt="need help icon"
            className="cursor-pointer"
          />
        </div>
      </div>
      <div className="font-normal text-[#221835] font-[Montserrat] text-[14px] lg:text-[18px]">
        Here's what's new
      </div>
      ...
      {value === 0 && (
        <>
          <div className="flex justify-center md:justify-start flex-wrap gap-x-[34px] gap-y-3">
            <div
              className="max-w-sm h-[148px] shadow-lg rounded-[10px] overflow-hidden  mt-6 p-6 w-[339px]"
              style={{
                background: "linear-gradient(135deg, #0F0B19 0%, #3E257B 100%)",
              }}
            >
              <div className="flex justify-between">
                ...
                <div className="flex flex-row bg-[#594292] rounded-full p-[6px]">
